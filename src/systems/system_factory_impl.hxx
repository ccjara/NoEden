...
private:
    ...
    std::unique_ptr<game_system> create_unit_system(const manager_provider& managers);
    std::unique_ptr<game_system> create_grid_system(const manager_provider& managers);
public:
